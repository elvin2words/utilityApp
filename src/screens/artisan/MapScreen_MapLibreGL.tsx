...
import MapView, { Marker, UrlTile, Circle, LatLng, PROVIDER_GOOGLE, Polygon, Region } from "react-native-maps";
      ...
      {loading ? (
          ...
          >
            ...
            >
              ...
              <MapLibreGL.Camera
                zoomLevel={12}
                centerCoordinate={[31.0522, -17.8292]}
              />
              
              <MapLibreGL.PointAnnotation
                id="fault1"
                coordinate={[31.0522, -17.8292]}
              />
